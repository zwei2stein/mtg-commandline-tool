...
def deckPrice(deckCards, currency, threshold = None):
	...
	response = { "threshold": threshold, "currency": currency, "deckPrice": deckPrice.quantize(Decimal('.01'), rounding=ROUND_DOWN), "sideboardPrice": sideboardPrice.quantize(Decimal('.01'), rounding=ROUND_DOWN), "totalPrice": totalPrice.quantize(Decimal('.01'), rounding=ROUND_DOWN), "commanderPrice": commanderPrice.quantize(Decimal('.01'), rounding=ROUND_DOWN) }
